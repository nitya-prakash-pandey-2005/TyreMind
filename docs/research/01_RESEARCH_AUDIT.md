...
| Cross-domain transfer | YELLOW | Built on NASA C-MAPSS with real ground truth. RUL RMSE 26.5 cycles over 40 of the 100 FD001 test engines — a runtime limit, and indicative rather than like-for-like. |
