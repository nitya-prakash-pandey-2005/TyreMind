...
> race in our corpus — **77 of them** — the naive method comes out negative in
> **74% of races** and in **53% of the 208 compound-stints**. More often than not,
...
- **Practice → race:** 0.0807 vs 0.1471 MAE across 42 events and 62 compound
  comparisons, 95% coverage after conformal calibration — and a systematic
  +0.027 s/lap bias we report rather than tune away.
